...
export class Shop extends Component {
    ...
    render() {
        return (
            <div>
                <h1 className="title"> Welcome to BhaminiShop </h1>
                <div className="items">
                    <div className="item">
                        <p>DEll Insprion Laptop</p>
                        <p>Available:{this.props.numOfLaptops}</p>
                        <button onClick={this.props.buyLaptop}>BUY Laptop</button>
                    </div>
                    <div className="item">
                        <p>Mobile Insprion </p>
                        <p>Available:{this.props.numOfMobiles}</p>
                        <button onClick={this.props.buyMobile}>BUY Mobile</button>
                    </div> 
                    <div className="item">
                        <p>Get User Data </p>
